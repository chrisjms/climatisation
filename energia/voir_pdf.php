<?php
// voir_pdf.php — Stream robuste des PDF (energia_devis/facture/bdc) sans 404 Apache.
// Utilise la DB pour récupérer le chemin stocké, sinon reconstruit depuis numéro/id.
//
// Usage: voir_pdf.php?src=energia_devis|facture|bdc&id=123
